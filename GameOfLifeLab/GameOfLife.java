    ...
    //    private final int X4 = 5, Y4 = 6;
        ...
        public void createNextGeneration()
        {
           ...
           // world.setGrid(grid);
            ...
            ArrayList<Location> newNextGen = new ArrayList<Location>();
            
            // this is for removing cells in the next generation
            ArrayList<Location> removeNextGen = new ArrayList<Location>();
            //alive cells around one cell
            ArrayList <Location> occupiedList;
            ...
            /*
             * Outer loop will test for each cell's rows and the inner loop will test for each cell's surroundings
             */
            for (x = 0; x < ROWS; x++)
            {
                for(y = 0; y < COLS; y++)
